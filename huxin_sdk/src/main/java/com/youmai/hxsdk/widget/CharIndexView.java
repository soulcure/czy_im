...
public class CharIndexView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.youmai.hxsdk.R.styleable.CharIndexView);
            textSize = a.getDimension(com.youmai.hxsdk.R.styleable.CharIndexView_indexTextSize, textSize);
            textColor = a.getColor(com.youmai.hxsdk.R.styleable.CharIndexView_charTextColor, textColor);
            indexTextColor = a.getColor(com.youmai.hxsdk.R.styleable.CharIndexView_indexTextColor, indexTextColor);
            a.recycle();
        }
        indexDrawable = context.getResources().getDrawable(com.youmai.hxsdk.R.drawable.charIndexColor);
