...
public class IMGroupActivity extends SdkBaseActivity implements
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        groupType = fromIntent.getIntExtra(GROUP_TYPE, YouMaiBasic.GroupType.GROUP_TYPE_MULTICHAT_VALUE);
        ...
        if (groupType == 2) {
            IMMsgManager.instance().removeBadgeComm(groupId);
        } else {
...
//                .pickFile(this);
    ...
    private void reqGroupMembers(int groupId) {//降低请求用户信息次数
