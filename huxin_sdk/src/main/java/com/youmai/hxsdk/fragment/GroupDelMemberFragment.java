 ...
 * 描述：
 */
public class GroupDelMemberFragment extends Fragment implements ContactAdapter.ItemEventListener {

    public static final String TAG = GroupDelMemberFragment.class.getName();
    ...
    public static GroupDelMemberFragment newInstance(boolean isShowCheck) {
        GroupDelMemberFragment fragment = new GroupDelMemberFragment();
    ...
    public static GroupDelMemberFragment newInstance(boolean isShowCheck, ArrayList<ContactBean> list) {
        GroupDelMemberFragment fragment = new GroupDelMemberFragment();
        Bundle bundle = new Bundle();
        bundle.putBoolean(SHOW_CHECK, isShowCheck);
        bundle.putParcelableArrayList(MEMBER_LIST, list);
        fragment.setArguments(bundle);
        return fragment;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            ArrayList<ContactBean> memberList = bundle.getParcelableArrayList(MEMBER_LIST);

            if (!ListUtils.isEmpty(memberList)) {
                contactSortByPinyin(memberList);
            }
        }
    }
    ...
    private void initView(View view) {
        ...
        adapter = new ContactAdapter(mContext, contactList, isShowCheck, null, this);
