...
public class CircleProgressView extends ProgressBar {
     ...
     * 已完成进度条大小
     */
    private int mReachBarSize = DisplayUtil.dip2px(getContext(), 2);
    /**
     * 未完成进度条大小
     */
    private int mNormalBarSize = DisplayUtil.dip2px(getContext(), 2);
    /**
     * 已完成进度颜色
     */
     ...
     * 进度值字体大小
     */
    private int mTextSize = DisplayUtil.sp2px(getContext(), 14);
    /**
     * 进度的值字体颜色
     */
     ...
     * 半径
     */
    private int mRadius = DisplayUtil.dip2px(getContext(), 20);
    /**
     * 起始角度
     */
     ...
     * 内部圆与外部圆间距
     */
    private int mInnerPadding = DisplayUtil.dip2px(getContext(), 1);
    /**
     * 外部圆环颜色
     */
     ...
     * 外层圆环宽度
     */
    private int mOuterSize = DisplayUtil.dip2px(getContext(), 1);
