package com.youmai.hxsdk.view.pickerview.lib;
...
import com.youmai.hxsdk.view.pickerview.adapter.WheelAdapter;
import com.youmai.hxsdk.view.pickerview.listener.OnItemSelectedListener;
import com.youmai.hxsdk.view.pickerview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.hx_pickerview_textsize);//默认大小
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.hx_pickerview, 0, 0);
            mGravity = a.getInt(R.styleable.hx_pickerview_hx_pickerview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.hx_pickerview_hx_pickerview_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.hx_pickerview_hx_pickerview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.hx_pickerview_hx_pickerview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.hx_pickerview_hx_pickerview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.hx_pickerview_hx_pickerview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
