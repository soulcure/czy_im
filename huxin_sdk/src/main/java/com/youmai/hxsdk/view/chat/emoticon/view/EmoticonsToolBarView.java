...
public class EmoticonsToolBarView extends RelativeLayout {
    ...
    public void setToolBtnSelect(int select) {
        ...
        for (int i = 0; i < mToolBtnList.size(); i++) {
            if (select == i) {
                mToolBtnList.get(i).setBackgroundColor(getResources().getColor(R.color.im_bg));
            } else {
    ...
    public void addData(int rec) {
        if (ly_tool != null) {
            ...
            LinearLayout.LayoutParams imgParams = new LinearLayout.LayoutParams(Utils.dip2px(mContext, mBtnWidth), Utils.dip2px(mContext, mBtnHeight));
    ...
    /**
     * @param selectPage default:0
     */
    public void setEmoticonContents(EmoticonsKeyboardBuilder builder, int selectPage) {
