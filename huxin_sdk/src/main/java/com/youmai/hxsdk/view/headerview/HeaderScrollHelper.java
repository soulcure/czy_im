...
public class HeaderScrollHelper {
    ...
    public boolean isVisible() {
        View scrollableView = getScrollableView();
        if (scrollableView == null) {
            throw new NullPointerException("scrollableView must be a instance of AdapterView|ScrollView|RecyclerView");
        }
        return scrollableView.getVisibility() == View.VISIBLE;
    }
