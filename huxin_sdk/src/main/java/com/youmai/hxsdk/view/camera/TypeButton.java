...
public class TypeButton extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (button_type == TYPE_CANCEL) {
            ...
            mPaint.setColor(ContextCompat.getColor(getContext(), R.color.return_cancel_bg));
            mPaint.setStyle(Paint.Style.FILL);
            canvas.drawCircle(center_X, center_Y, button_radius, mPaint);

            mPaint.setColor(ContextCompat.getColor(getContext(), R.color.return_cancel));
        ...
        if (button_type == TYPE_CONFIRM) {
            mPaint.setAntiAlias(true);
            mPaint.setColor(ContextCompat.getColor(getContext(), R.color.hx_color_white));
            mPaint.setStyle(Paint.Style.FILL);
            canvas.drawCircle(center_X, center_Y, button_radius, mPaint);
            mPaint.setAntiAlias(true);
            mPaint.setStyle(Paint.Style.STROKE);
            mPaint.setColor(ContextCompat.getColor(getContext(), R.color.hx_main_color));
            mPaint.setStrokeWidth(strokeWidth);
