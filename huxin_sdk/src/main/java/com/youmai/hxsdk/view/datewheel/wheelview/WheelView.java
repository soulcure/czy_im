...
package com.youmai.hxsdk.view.datewheel.wheelview;
...
public class WheelView extends View {
	...
	/** Top and bottom items offsetX (to hide that) */
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.hx_wheel_bg;
	private int wheelForeground = R.drawable.hx_wheel_val;
...
//		int offsetX = 60;
		...
		centerDrawable.setBounds(0, center - offsetX, getWidth(), center + offsetX);
