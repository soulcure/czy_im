package com.youmai.hxsdk.view.headerview;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.i("YW", "currentY: " + currentY + "\tshiftX: " + shiftX + "\tshiftY: " + shiftY
                        + " mTouchSlop: " + mTouchSlop + "\tgetScrollY()" + getScrollY() + "\tmHeadHeight: " + mHeadHeight);
                /**
                ...
                if (verticalScrollFlag && (!isStickied() || mScrollable.isTop() || isClickHead)) {
                    ...
                    invalidate();
                    if (mScrollable.isTop() /*&& getScrollY() == 0*/ && getScrollY() < mHeadHeight) {
                        Log.i("YW", "--------: " + getScrollY());
                        return true;
                    }
                    if (getScrollY() < mHeadHeight) {
                        Log.i("YW", "1800 --------: " + getScrollY());
                        return true;
                    }
                }
                break;
