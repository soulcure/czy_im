...
import com.youmai.hxsdk.view.camera.util.CheckPermission;
import com.youmai.hxsdk.view.camera.util.LogUtil;

import static com.youmai.hxsdk.view.camera.JCameraView.BUTTON_STATE_BOTH;
import static com.youmai.hxsdk.view.camera.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.youmai.hxsdk.view.camera.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private int progress_color = 0xFF39a6FF;            //进度条颜色
    private int outside_color = 0xFFFFFFFF;             //外圆背景色
    private int inside_color = 0xFFD1D8DC;              //内圆背景色
