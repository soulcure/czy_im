package com.youmai.hxsdk.view.pickerview;
...
import com.youmai.hxsdk.view.pickerview.view.BasePickerView;
import com.youmai.hxsdk.view.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        private int layoutRes = R.layout.hx_pickerview_time;
        private CustomListener customListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.hx_pickerview_time, contentContainer);
        ...
        setTime();
        if (customListener != null) {
            wheelTime.setCustomCurrentDateListener(customListener);
            customListener.customCurrentDate(wheelTime.getTime());
        }
