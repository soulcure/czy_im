package com.youmai.hxsdk.view.pickerview.view;

import android.view.View;

import com.youmai.hxsdk.R;
import com.youmai.hxsdk.view.pickerview.adapter.ArrayWheelAdapter;
import com.youmai.hxsdk.view.pickerview.adapter.NumericWheelAdapter;
import com.youmai.hxsdk.view.pickerview.lib.WheelView;
...
import com.youmai.hxsdk.view.pickerview.utils.ChinaDate;
import com.youmai.hxsdk.view.pickerview.utils.LunarCalendar;
        ...
        OnItemSelectedListener wheelListener_year = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (mCustomListener != null) {
                    mCustomListener.customCurrentDate(getTime());
                }
            }
        };
        // 添加"月"监听
...
//                maxItem = endD;
    ...
    public void setCustomCurrentDateListener(CustomListener listener) {
