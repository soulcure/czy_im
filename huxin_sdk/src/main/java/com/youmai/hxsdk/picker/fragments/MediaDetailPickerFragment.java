...
public class MediaDetailPickerFragment extends BaseFragment {
    ...
    private void updateList(List<PhotoDirectory> dirs) {
        ...
        if (photoGridAdapter != null) {
            ...
            photoGridAdapter = new PhotoGridAdapter(getActivity(), mGlideRequestManager, medias, PickerManager.getInstance().getSelectedPhotos(), (fileType == FilePickerConst.MEDIA_TYPE_IMAGE) && PickerManager.getInstance().isEnableCamera());
