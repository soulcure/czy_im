...
public class AbFileUtil {
    ...
    public static Bitmap getBitmapFromSrc(String src) {
        ...
        try {
            ...
            LogUtils.e(AbFileUtil.class.getName(), "获取图片异常：" + e.getMessage());
        }
        return bit;
    }
    ...
    public static String downloadFile(String url, String dirPath) {
        ...
        try {
            ...
            connection.connect();
            // 获取文件名，下载文件
            String realFileName = getCacheFileNameFromUrl(url, connection);
    ...
    public static String hasFilePath(String url, String dirPath) {
        if (!isCanUseSD()) {
            return null;
        }
        // 先判断SD卡中有没有这个文件，不比较后缀部分比较
    ...
    public static int getContentLengthFromUrl(String Url) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.e(AbFileUtil.class.getName(), "获取长度异常：" + e.getMessage());
        }
    ...
    public static String getRealFileNameFromUrl(String url) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.e(AbFileUtil.class.getName(), "网络上获取文件名失败");
        }
        return name;
    }
     ...
     * @return File
     */
    public static File renameVideoTo(String oldVideoPath) {
        File newFile = new File(oldVideoPath.replace(".mp4", ".m"));
        new File(oldVideoPath).renameTo(newFile);
        return newFile;
    }
     ...
     * @return File
     */
    public static File renamePicTo(String oldPicPath) {
        File newFile = new File(oldPicPath.replace(".jpg", ".j"));
        new File(oldPicPath).renameTo(newFile);
        return newFile;
    }
     ...
     * @return String
     */
    public static String renameVideoTo2(String oldVideoPath) {
        File newFile = new File(oldVideoPath.replace(".mp4", ".m"));
        new File(oldVideoPath).renameTo(newFile);
     ...
     * @return String
     */
    public static String renamePicTo2(String oldPicPath) {
        File newFile = new File(oldPicPath.replace(".jpg", ".j"));
        new File(oldPicPath).renameTo(newFile);
        return newFile.getAbsolutePath();
    }
