...
public class OwnerMsgLoaderAct implements LoaderManager.LoaderCallbacks<List<ExCacheMsgBean>> {
    private static final String TAG = OwnerMsgLoaderAct.class.getSimpleName();

    private Context mContext;
    private ProtoCallback.CacheMsgCallBack callback;

    public OwnerMsgLoaderAct(Context context, ProtoCallback.CacheMsgCallBack callback) {
        mContext = context;
