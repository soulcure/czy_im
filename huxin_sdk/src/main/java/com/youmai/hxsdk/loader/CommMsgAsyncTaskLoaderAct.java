 ...
 */
public class CommMsgAsyncTaskLoaderAct extends AsyncTaskLoader<List<ExCacheMsgBean>> {

    private final String TAG = CommMsgAsyncTaskLoaderAct.class.getSimpleName();


    public CommMsgAsyncTaskLoaderAct(Context context) {
        super(context);
    }
