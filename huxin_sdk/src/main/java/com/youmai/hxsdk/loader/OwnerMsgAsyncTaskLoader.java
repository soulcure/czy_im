 ...
 */
public class OwnerMsgAsyncTaskLoader extends AsyncTaskLoader<List<ExCacheMsgBean>> {

    private final String TAG = OwnerMsgAsyncTaskLoader.class.getSimpleName();


    public OwnerMsgAsyncTaskLoader(Context context) {
        super(context);
    }
    ...
    private List<ExCacheMsgBean> getCacheMsgFromDBDesc() {
        List<CacheMsgBean> msgBeanList = CacheMsgHelper.instance().getAllOwnerMsg(getContext());
