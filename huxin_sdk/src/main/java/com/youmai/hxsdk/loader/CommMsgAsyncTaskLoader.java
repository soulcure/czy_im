 ...
 */
public class CommMsgAsyncTaskLoader extends AsyncTaskLoader<List<ExCacheMsgBean>> {

    private final String TAG = CommMsgAsyncTaskLoader.class.getSimpleName();


    public CommMsgAsyncTaskLoader(Context context) {
        super(context);
    }
