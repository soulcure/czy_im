 ...
 */
public class OwnerMsgAsyncTaskLoaderAct extends AsyncTaskLoader<List<ExCacheMsgBean>> {

    private final String TAG = OwnerMsgAsyncTaskLoaderAct.class.getSimpleName();


    public OwnerMsgAsyncTaskLoaderAct(Context context) {
        super(context);
    }
    ...
    private List<ExCacheMsgBean> getCacheMsgFromDBDesc() {
        List<CacheMsgBean> msgBeanList = CacheMsgHelper.instance().getAllCommMsg(getContext());
