 ...
 */
public class OwnerMsgListFragment extends Fragment implements IMMsgCallback {

    private final String TAG = OwnerMsgListFragment.class.getSimpleName();
    ...
    private static class MsgHandler extends Handler {
        WeakReference<OwnerMsgListFragment> weakReference;

        public MsgHandler(OwnerMsgListFragment fragment) {
            weakReference = new WeakReference<>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            OwnerMsgListFragment fragment = weakReference.get();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        HuxinSdkManager.instance().chatMsgFromCache(this, 101,
        ...
        mMessageAdapter.setOnItemClickListener(new MessageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(ExCacheMsgBean bean, int position) {
                if (bean.getUiType() == MessageAdapter.ADAPTER_TYPE_SINGLE) {//单聊
                    ...
                    HuxinSdkManager.instance().entryChatService(getContext(), uuid, nickName, avatar, userName, mobile);
