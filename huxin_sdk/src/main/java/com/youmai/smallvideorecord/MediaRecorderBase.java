package com.youmai.smallvideorecord;
...
import com.youmai.smallvideorecord.jniinterface.FFmpegBridge;
import com.youmai.smallvideorecord.model.BaseMediaBitrateConfig;
import com.youmai.smallvideorecord.model.MediaObject;
import com.youmai.smallvideorecord.utils.DeviceUtils;
import com.youmai.smallvideorecord.utils.FFMpegUtils;
import com.youmai.smallvideorecord.utils.FileUtils;
...
//		TODO 设置浏览尺寸
    ...
    protected Boolean doCompress(boolean mergeFlag, boolean isSound) {
        ...
        if (compressConfig != null) {
            ...
            String cmd;
            if (isSound) {
                cmd = "ffmpeg -threads 16 -i %s -c:v libx264 %s %s %s -c:a libfdk_aac %s %s %s %s";
            } else {
                cmd = "ffmpeg -threads 16 -i %s -c:v libx264 %s %s %s %s %s %s -an %s";
            }

            String cmd_transcoding = String.format(cmd,
